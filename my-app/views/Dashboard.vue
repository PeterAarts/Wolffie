<template>
  <div class="min-h-screen bg-[#f9fafb] lg:grid lg:grid-cols-[2fr_1fr] lg:gap-0 overflow-hidden text-[#111827]">
    
    <div class="hero-card p-6 lg:p-10 bg-[#f9fafb] border-r border-gray-200 lg:h-screen overflow-y-auto">
    ...
    <div class="section flex flex-col bg-white lg:h-screen">
      <div class="flex justify-between items-center p-6  border-b border-gray-200 bg-white">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="font-mono text-sm text-gray-500 font-medium">{{ currentTime }}</div>
        </div>
      </div>
      ...
      <div class="flex-1 overflow-y-auto">
        <transition 
          ...
          mode="out-in"
        >
          <div v-if="!showSocketsList" key="power-cards" class="flex flex-col bg-[#f9fafb]">
            ...
            <div class="flex items-center p-6 lg:p-8 bg-[#f9fafb] transition-all">
              <div class="w-12 h-12 flex items-center justify-center text-2xl text-gray-800">
              ...
              <div class="flex-1 ml-4 min-w-0">
                ...
                <div class="text-xs font-mediumbold text-gray-400 lowercase tracking-wider ">Huidig: {{ formatPowerValue(currentSolarPower) }}</div>
              </div>
              <div class="text-right flex-shrink-0">
            ...
            <div @click="toggleSocketsList" class="flex items-center p-6 lg:p-8 bg-[#f9fafb] cursor-pointer hover:bg-gray-100 transition-all group relative">
              <div class="w-12 h-12 flex items-center justify-center text-2xl text-gray-800">
              ...
              <div class="flex-1 ml-4 min-w-0">
                ...
                <div class="text-xs font-mediumbold text-gray-400 lowercase tracking-wider ">Huidig: {{ formatPowerValue(currentHomePower) }}</div>
              </div>
              <div class="text-right flex-shrink-0">
          ...
          <div v-else key="devices-list" class="flex flex-col bg-white h-full">
            <div class="flex items-center justify-between p-6 border-b border-gray-100">
              <h3 class="text-lg font-bold flex items-center gap-2 m-0 text-gray-900">
                <i class="fa-duotone fa-plug-circle-bolt"></i> Home Devices
              </h3>
