<template>
  <div class="dashboard-container">
    ...
    <div class="section section-relative">
      ...
      <!-- Content Area - Swaps between power cards and devices list -->
      <transition name="fade-swap" mode="out-in">
        <!-- Consumption Breakdown Cards -->
        <div v-if="!showSocketsList" key="power-cards" class="breakdown-cards">
          ...
          <div class="breakdown-card">
            ...
            <div class="breakdown-content">
              <div class="breakdown-name">Battery  ({{ currentBatterySOC }}% )</div>
            ...
            <div class="breakdown-percentage">
              <div class="percentage-large"> {{ currentBatteryPower }} W</div>
          ...
          <div class="breakdown-card">
            ...
            <div class="breakdown-content">
              ...
              <div class="breakdown-detail">Teruglevering: {{ parseFloat(realtimeStore.summaryData.today_grid_export || 0).toFixed(2) }} kWh</div>
        ...
        <!-- Devices List Panel -->
        <div v-else key="devices-list" class="devices-panel">
          <div class="devices-header">
            <h3 class="devices-title">
              <i class="pi pi-home"></i> Home Devices
            </h3>
            <button @click="toggleSocketsList" class="close-button">
...
/* Devices Panel - replaces the power cards */
.devices-panel {
  display: flex;
  flex-direction: column;
  background: #fff;
