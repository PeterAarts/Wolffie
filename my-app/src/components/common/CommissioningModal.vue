          ...
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              ...
              <div class="mt-6 space-y-4">
                ...
                <div>
                  <label class="block text-sm font-semibold text-gray-700 mb-1">Pairing Code</label>
                  <input 
                    type="text" 
