...
class ForecastSolarAPI {
  ...
  async getForecast({ latitude, longitude, tilt = 35, azimuth = 180, kwp }) {
    ...
    try {
      console.log(`\x1b[37m   • Solar Forecast API - lat=${latitude} lon=${longitude} ${kwp}kWp\x1b[0m`);
  ...
  normalizeResponse(data) {
    ...
    console.log(`\x1b[37m   • Solar Forecast: ${Object.keys(hourlyWh).length} days, daily totals: ${JSON.stringify(wattHoursDay)}\x1b[0m`);
